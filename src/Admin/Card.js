...
const Card = () => {
  ...
  const approvedDoctors = doctorData.filter(doctor => doctor.status === 'Approved');
      ...
      {doctorData.map((doctor, index) => (
        <div key={index} className="card">
          <div className="card-info">
            ...
            <div className="card-title">{doctor.agent_Name}</div>
            
            <div className="card-subtitle">Agent ID: {doctor.agent_Id}</div>
            <div className="card-subtitle">Status: {doctor.status}</div>
          </div>
