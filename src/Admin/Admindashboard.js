...
import ActiveDoctor from './ActiveDoctor'; // Replace with the actual path to the ActiveDoctor component
import Card from './Card'; // Replace with the actual path to the Card component
    ...
    <section id="dashboard">
      ...
      <section id="sidebar">
        ...
        <ul className="side-menu top">
          ...
          <li>
          <button onClick={handleViewClick} className="link-button" style={{ marginLeft: '15%', background: 'transparent' }} data-target="agent">
  <i className='bx bxs-doughnut-chart'></i>
  <span className="text">View Agents</span>
</button>
          </li>
          <li>
      ...
      {isAgentView && (
        ...
        <ul className="side-menu">
          ...
          <li>
            <a href="/logoutadmin" className="logout">
